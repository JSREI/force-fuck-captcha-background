...
const App: React.FC = () => {
  ...
  const docLinks = [
    ...
    { title: '本地还原工具', href: '#local-restore', desc: 'UI 操作入口与进度管理' },
    ...
    <AppLayout>
      <div className="page home-page">
        <Space direction="vertical" size="large" style={{ width: '100%' }}>
          <section className="hero" id="overview">
            <div className="hero-content">
              ...
              <Space wrap className="hero-actions">
                ...
                <Button size="large" href="#local-restore">本地还原工具</Button>
              </Space>
          ...
          <section id="local-restore" className="section">
            <div className="section-header">
              <Title level={3} className="section-title">本地还原工具</Title>
              <Text type="secondary">直接在本地完成样本扫描、背景聚类与导出。</Text>
            </div>
